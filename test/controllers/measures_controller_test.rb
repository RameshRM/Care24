...
class MeasuresControllerTest < ActionController::TestCase
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post :create, measure: { data: @measure.data, name: @measure.name, patient_id: @measure.patient_id, type: @measure.type }
    end
  ...
  test "should update measure" do
    patch :update, id: @measure, measure: { data: @measure.data, name: @measure.name, patient_id: @measure.patient_id, type: @measure.type }
    assert_redirected_to measure_path(assigns(:measure))
  end
